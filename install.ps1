...
if ($InstallVersion -ne "") {
    ...
    $ApiUrl = "https://api.github.com/repos/rabbits0209/komari-agent/releases/latest"
    try {
...
$BinaryName = "komari-agent-windows-$arch.exe"
$DownloadUrl = if ($GitHubProxy) { "$GitHubProxy/https://github.com/rabbits0209/komari-agent/releases/download/$versionToInstall/$BinaryName" } else { "https://github.com/rabbits0209/komari-agent/releases/download/$versionToInstall/$BinaryName" }
